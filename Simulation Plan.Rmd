      ...
      \[
        \beta = 
          \begin{pmatrix} 
            ...
            \mathbf{0}_{(p-3) \times 1} & \mathbf{1}_{3 \times 1} & \mathbf{0}_{3\times 1} & \mathbf{0}_{3 \times (p-3)}\\
            \mathbf{0}_{(p-3) \times 1} & \mathbf{0}_{(p-3) \times 1} &\mathbf{1}_{3 \times 1} &\mathbf{0}_{3 \times (p-3)}\\
